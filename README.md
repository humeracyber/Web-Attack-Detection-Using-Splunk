...
This project is a Security Information and Event Management (SIEM) use case built using Splunk. It analyzes HTTP logs to detect common web attacks such as brute force login attempts, SQL injection, suspicious file access, and command execution attempts.
...
web-attack-detection-splunk/ │ ├── dashboards/ │ └── http_attack_dashboard.xml │ ├── queries/ │ └── spl_queries.txt │ ├── screenshots/ │ ├── dashboard.png │ └── README.md
...
Humera Cybersecurity / SOC Analyst Aspirant
